...
if __name__ == '__main__':
	...
	for epoch_id, idx, batch in batch_iter(dataloader, params):
	    ...
	    if params['mode'] == 2:
		vid_loss = forward(dialog_encoder, batch, params, sample_size=params['batch_size'])
	    else:
		sample_size = 1
		...
		for metric_name, metric_value in all_metrics.items():
			...
			viz.linePlot(iter_id, metric_value, 'Retrieval Round Val Metrics Round -' + metric_name.split('_')[-1],
				     metric_name)
		    else:
